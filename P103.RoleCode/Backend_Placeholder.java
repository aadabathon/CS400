...
public class Backend_Placeholder implements BackendInterface {
    ...
    public List<String> getAndSetRange(Integer low, Integer high) {
        String lowString = (char)('A'+(low==null?0:low))+" string";
        Song lowSong = new Song(lowString,lowString,lowString,
                                low,low,low,low,low,low);
        String highString = (char)('A'+(high==null?0:high))+" string";
    ...
    // filters are being completely ignored here, and the fivemost energetic
