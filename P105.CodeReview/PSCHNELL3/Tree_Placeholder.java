...
public class Tree_Placeholder implements IterableSortedCollection<Song> {
    ...
    public boolean contains(Comparable<Song> find) throws NullPointerException {
    ...
    private List<Song> songs = Arrays.asList(
        ...
        new Song("D", "Simon & Garfunkel", "EDM", 2000, 119, 100, 77, -5, 4),
        new Song("E", "twenty one pilots", "country", 2027, 40, 67, 67, -5, 4));
